...
Se connecter sur <https://kumbuka.univ-pau.fr/login> avec ses identifiants.
:::
...
- Aller dans `Collections` (*Panneau de gauche*).

- Puis sélectionner sa collection.
...
- Enfin `Rechercher par propriétaire`.
